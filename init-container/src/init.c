...
static noreturn void main_loop(void) {
    ...
    printf("  _______  _____  ___     ____________________  \n");
    printf(" / ___/ / / / _ \\/ _ |   /_  __/ __/ __/_  __/ \n");
    printf("/ /__/ /_/ / // / __ |    / / / _/_\\ \\  / /   \n");
    printf("\\___/\\____/____/_/ |_|   /_/ /___/___/ /_/    \n");
    printf("                                                \n\n");

    //system("\\ls -laR"); printf("\n\n");
